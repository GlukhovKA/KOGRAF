...
@Component({
  selector: 'app-client-acc-conference',
  templateUrl: './client-acc-conference.html',
  styleUrls: ['./client-acc-conference.css']
})
export class ConferenceClientComponent implements OnInit {
